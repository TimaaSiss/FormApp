...
const step3Schema = z.object({
  ...
  contenuDisponible: z
    .enum(["Oui, tout prêt", "Partiellement", "Non, besoin d’aide"])
    .optional(),
...
const step5Schema = z.object({
  typesProduitsServices: z
    .array(z.enum(["Physiques", "Numériques", "Services", "Abonnements"]))
    .optional(),
  nombreProduits: z
    .enum(["< 50", "50 - 500", "500 - 5 000", "> 5 000"])
    .optional(),
  besoinsSpecifiques: z
    .array(
      z.enum([
        "Gestion stock",
        "Variantes produits",
...
const step12Schema = z.object({
  ...
  strategieExistante: z
    .enum(["Oui", "Non", "En cours", "Besoin de conseils"])
    .optional(),
});

const step13Schema = z.object({
  importanceReferencement: z
    .enum(["Essentiel", "Souhaité mais pas prioritaire", "Non", "Ne sais pas"])
    .optional(),
  accompagnementSEO: z
    .array(
      z.enum([
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      const finalData = {
        ...
        objectifs: [
          ...(data.objectifs || []),
          ...(data.objectifAutre ? [data.objectifAutre] : []),
        ],
        pages: [
          ...(data.pages || []),
          ...(data.pageAutre ? [data.pageAutre] : []),
        ],
        fonctionnalites: [
          ...(data.fonctionnalites || []),
          ...(data.fonctionnaliteAutre ? [data.fonctionnaliteAutre] : []),
        ],
        stylePrefere: [
          ...(data.stylePrefere || []),
        ...
        plateformesCM: [
          ...(data.plateformesCM || []),
          ...(data.autrePlateformeCM ? [data.autrePlateformeCM] : []),
        ],
        besoinsComDigitale: [
          ...(data.besoinsComDigitale || []),
          ...(data.autreBesoinCom ? [data.autreBesoinCom] : []),
        ],
        accompagnementSEO: [
          ...(data.accompagnementSEO || []),
          ...(data.autreAccompagnementSEO ? [data.autreAccompagnementSEO] : []),
        ],
      };
      ...
      const message = await render(
        ConfirmationEmail({ userName: `${data.contactNom}` })
      );

      await sendMail({
        html: message,
        subject: "Confirmation de votre soumission",
        to: `${data.contactNom} <${data.email}>`,
      });
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <input
                        {...register("nomProjet", {
                          onChange: (e) =>
                            onChange({ nomProjet: e.target.value }),
                        })}
                        id="nomProjet"
                    ...
                    <div>
                      ...
                      <input
                        {...register("contactNom", {
                          onChange: (e) =>
                            onChange({ contactNom: e.target.value }),
                        })}
                        id="contactNom"
                        className="mt-1 w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                      />
                    ...
                    <div>
                      ...
                      <input
                        {...register("contactFonction", {
                          onChange: (e) =>
                            onChange({ contactFonction: e.target.value }),
                        })}
                        id="contactFonction"
                        className="mt-1 w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                      />
                    ...
                    <div>
                      ...
                      <input
                        {...register("siteWeb", {
                          onChange: (e) =>
                            onChange({ siteWeb: e.target.value }),
                        })}
                        id="siteWeb"
                        className="mt-1 w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        {...register("dateMiseEnLigne", {
                          onChange: (e) =>
                            onChange({ dateMiseEnLigne: e.target.value }),
                        })}
                        id="dateMiseEnLigne"
                        className="mt-1 w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                      />
                    ...
                    <div>
                      ...
                      <input
                        {...register("evenementAssocie", {
                          onChange: (e) =>
                            onChange({ evenementAssocie: e.target.value }),
                        })}
                        id="evenementAssocie"
                        className="mt-1 w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                      />
                              ...
                              {...register("objectifs", {
                                onChange: (
                                  ...
                                  const values = Array.from(
                                    e.target.form?.querySelectorAll<HTMLInputElement>(
                                      `input[name="objectifs"]:checked`
                                    ) || []
                                  ).map((el) => el.value);
                        ...
                        <label className="flex items-center gap-2">
                          ...
                          <input
                            {...register("objectifAutre", {
                              onChange: (e) =>
                                onChange({ objectifAutre: e.target.value }),
                            })}
                    ...
                    <div>
                      ...
                      <input
                        {...register("publicCible", {
                          onChange: (e) =>
                            onChange({ publicCible: e.target.value }),
                        })}
                        id="publicCible"
                        className="mt-1 w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                      />
                      ...
                      <div className="mt-2 flex flex-col gap-3">
                        ...
                        <label className="flex items-center gap-2">
                          ...
                          <input
                            {...register("pageAutre", {
                              onChange: (e) =>
                                onChange({ pageAutre: e.target.value }),
                            })}
                            className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                          />
                        </label>
                    ...
                    <div>
                      ...
                      <select
                        {...register("contenuDisponible", {
                          onChange: (e) =>
                            onChange({ contenuDisponible: e.target.value }),
                        })}
                      ...
                      >
                        ...
                        <option value="Non, besoin d’aide">
                          Non, besoin d’aide
                        </option>
                      </select>
                    </div>
                      ...
                      <label className="flex items-center gap-2">
                        <input
                          ...
                          {...register("pagesAMettreJour", {
                            onChange: (e) =>
                              onChange({ pagesAMettreJour: e.target.checked }),
                          })}
                          className="h-4 w-4 text-[#1E3A8A] border-gray-300 rounded focus:ring-[#D4AF37]"
                        />
                        <span className="text-gray-700">
                          Certaines pages à mettre à jour régulièrement ?
                        </span>
                      </label>
                    </div>
                  </div>
                            ...
                            <input
                              ...
                              {...register("fonctionnalites", {
                                onChange: (e) => {
                                  const values = e.target.form
                                    ?.querySelectorAll(
                                      `input[name="fonctionnalites"]:checked`
                                    )
                                    .map((el: HTMLInputElement) => el.value);
                        ...
                        <label className="flex items-center gap-2">
                          ...
                          <input
                            {...register("fonctionnaliteAutre", {
                              onChange: (e) =>
                                onChange({
                                  fonctionnaliteAutre: e.target.value,
                                }),
                            })}
                            className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                          />
                            ...
                            <input
                              ...
                              {...register("typesProduitsServices", {
                                onChange: (e) => {
                                  const values = e.target.form
                                    ?.querySelectorAll(
                                      `input[name="typesProduitsServices"]:checked`
                                    )
                                    .map((el: HTMLInputElement) => el.value);
                            ...
                            <input
                              ...
                              {...register("besoinsSpecifiques", {
                                onChange: (e) => {
                                  const values = e.target.form
                                    ?.querySelectorAll(
                                      `input[name="besoinsSpecifiques"]:checked`
                                    )
                                    .map((el: HTMLInputElement) => el.value);
                            ...
                            <input
                              ...
                              {...register("designAssets", {
                                onChange: (e) => {
                                  const values = e.target.form
                                    ?.querySelectorAll(
                                      `input[name="designAssets"]:checked`
                                    )
                                    .map((el: HTMLInputElement) => el.value);
                      ...
                      <div className="mt-2 flex flex-col gap-3">
                            ...
                            <input
                              ...
                              {...register("stylePrefere", {
                                onChange: (e) => {
                                  const values = e.target.form
                                    ?.querySelectorAll(
                                      `input[name="stylePrefere"]:checked`
                                    )
                                    .map((el: HTMLInputElement) => el.value);
                        ...
                        <label className="flex items-center gap-2">
                          ...
                          <input
                            {...register("styleAutre", {
                              onChange: (e) =>
                                onChange({ styleAutre: e.target.value }),
                            })}
                            className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                          />
                        </label>
                          ...
                          <label key={opt} className="flex items-center gap-2">
                            <input
                              ...
                              {...register("gestionSite", {
                                onChange: (e) =>
                                  onChange({ gestionSite: e.target.value }),
                              })}
                              className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                            />
                          ...
                          <label key={opt} className="flex items-center gap-2">
                            <input
                              ...
                              {...register("hebergement", {
                                onChange: (e) =>
                                  onChange({ hebergement: e.target.value }),
                              })}
                              className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                            />
                            <span className="text-gray-700">{opt}</span>
                          ...
                          <label key={opt} className="flex items-center gap-2">
                            <input
                              ...
                              {...register("connexionOutils", {
                                onChange: (e) =>
                                  onChange({ connexionOutils: e.target.value }),
                              })}
                              className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                            />
                            <span className="text-gray-700">{opt}</span>
                          ...
                          <label key={opt} className="flex items-center gap-2">
                            <input
                              ...
                              {...register("respectRGPD", {
                                onChange: (e) =>
                                  onChange({ respectRGPD: e.target.value }),
                              })}
                              className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                            />
                            <span className="text-gray-700">{opt}</span>
                          ...
                          <label key={opt} className="flex items-center gap-2">
                            <input
                              ...
                              {...register("sauvegardesAuto", {
                                onChange: (e) =>
                                  onChange({ sauvegardesAuto: e.target.value }),
                              })}
                              className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                            />
                            <span className="text-gray-700">{opt}</span>
                            ...
                            <input
                              ...
                              {...register("besoinsMaintenance", {
                                onChange: (
                                  ...
                                  const values = Array.from(
                                    e.target.form?.querySelectorAll<HTMLInputElement>(
                                      `input[name="besoinsMaintenance"]:checked`
                                    ) || []
                                  )
                        ...
                        {["En une fois", "En plusieurs étapes"].map((opt) => (
                          <label key={opt} className="flex items-center gap-2">
                            <input
                              ...
                              {...register("paiement", {
                                onChange: (e) =>
                                  onChange({ paiement: e.target.value }),
                              })}
                              className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                            />
                            <span className="text-gray-700">{opt}</span>
                        ...
                        {["Oui", "Non"].map((opt) => (
                          <label key={opt} className="flex items-center gap-2">
                            <input
                              ...
                              {...register("appelOffre", {
                                onChange: (e) =>
                                  onChange({ appelOffre: e.target.value }),
                              })}
                              className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                            />
                            <span className="text-gray-700">{opt}</span>
                ...
                {step === 11 && (
                  <div className="space-y-6">
                          ...
                          <label key={item} className="flex items-center gap-2">
                            <input
                              ...
                              {...register("accompagnementCM", {
                                onChange: (e) =>
                                  onChange({
                                    accompagnementCM: e.target.value,
                                  }),
                              })}
                              className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                            />
                            ...
                            <input
                              ...
                              {...register("plateformesCM", {
                                onChange: (
                                  ...
                                  type PlateformeValue =
                                    (typeof validValues)[number];
                                  const values = Array.from(
                                    e.target.form?.querySelectorAll<HTMLInputElement>(
                                      `input[name="plateformesCM"]:checked`
                                    ) || []
                                  )
                        ...
                        <label className="flex items-center gap-2">
                          ...
                          <input
                            {...register("autrePlateformeCM", {
                              onChange: (e) =>
                                onChange({ autrePlateformeCM: e.target.value }),
                            })}
                            className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                          />
                        </label>
                            ...
                            <input
                              ...
                              {...register("besoinsComDigitale", {
                                onChange: (
                                  ...
                                  const values = Array.from(
                                    e.target.form?.querySelectorAll<HTMLInputElement>(
                                      `input[name="besoinsComDigitale"]:checked`
                                    ) || []
                                  )
                        ...
                        <label className="flex items-center gap-2">
                          ...
                          <input
                            {...register("autreBesoinCom", {
                              onChange: (e) =>
                                onChange({ autreBesoinCom: e.target.value }),
                            })}
                            className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                          />
                        </label>
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex flex-col gap-3">
                        {["Oui", "Non", "En cours", "Besoin de conseils"].map(
                          (opt) => (
                            <label
                              key={opt}
                              className="flex items-center gap-2"
                            >
                              <input
                                ...
                                {...register("strategieExistante", {
                                  onChange: (e) =>
                                    onChange({
                                      strategieExistante: e.target.value,
                                    }),
                                })}
                                className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                              />
                          ...
                          <label key={opt} className="flex items-center gap-2">
                            <input
                              ...
                              {...register("importanceReferencement", {
                                onChange: (e) =>
                                  onChange({
                                    importanceReferencement: e.target.value,
                                  }),
                              })}
                              className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                            />
                            ...
                            <input
                              ...
                              {...register("accompagnementSEO", {
                                onChange: (
                                  ...
                                  const values = Array.from(
                                    e.target.form?.querySelectorAll<HTMLInputElement>(
                                      `input[name="accompagnementSEO"]:checked`
                                    ) || []
                                  )
                        ...
                        <label className="flex items-center gap-2">
                          ...
                          <input
                            {...register("autreAccompagnementSEO", {
                              onChange: (e) =>
                                onChange({
                                  autreAccompagnementSEO: e.target.value,
                                }),
                            })}
                            className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-colors"
                          />
                          ...
                          <label key={opt} className="flex items-center gap-2">
                            <input
                              ...
                              {...register("gestionEReputation", {
                                onChange: (e) =>
                                  onChange({
                                    gestionEReputation: e.target.value,
                                  }),
                              })}
                              className="h-4 w-4 text-[#1E3A8A] border-gray-300 focus:ring-[#D4AF37]"
                            />
                            ...
                            <input
                              ...
                              {...register("actionsAvis", {
                                onChange: (
                                  ...
                                  const values = Array.from(
                                    e.target.form?.querySelectorAll<HTMLInputElement>(
                                      `input[name="actionsAvis"]:checked`
                                    ) || []
                                  )
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <textarea
                        {...register("remarques", {
                          onChange: (e) =>
                            onChange({ remarques: e.target.value }),
                        })}
                        id="remarques"
            ...
            {success && (
              ...
              >
                ...
                <p className="text-gray-600 text-sm mt-1">
                  Le formulaire sera réinitialisé dans quelques secondes.
                </p>
              </motion.div>
            )}
            {error && (
